...
with st.form("input_form"):
    ...
    PropertyType = st.selectbox("Property Type", ['Residential', 'ResidentialLease', 'ResidentialIncome', 'Land', 'CommercialLease', 'ManufacturedInPark', 'CommercialSale', 'BusinessOpportunity'])
